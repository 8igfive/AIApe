...
|[/api/favorites/favorite](#获取收藏夹的详细信息-apifavoritesfavorite)|`POST`|`用户`|获取收藏夹的详细信息|
...
## 收藏问题 /api/favorites/colloect_question

* 权限：`用户`
* url格式：

```
{BASE_URL}/api/favorites/colloect_question
```
* 类型：POST
* 请求体：
...
|`userNotConsist`|`401 Unauthorized`|`fid`所对应的收藏夹不是当前用户的收藏夹|
